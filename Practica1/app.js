function init(){
    ...
    function nextSlide(pageNumber){
        ...
        tl.fromTo(currentLeft, 0.3, {y: "-10%"},  {y: "-100%"})
          ...
          .fromTo(currentPage, 0.3, {opacity:1, PointerEvent: "all"}, {opacity:0, PointerEvent: "none"})
          .fromTo(nextPage, 0.3, {opacity:0, PointerEvent: "none"}, {opacity:1, PointerEvent: "all"}, "-=0.6")
